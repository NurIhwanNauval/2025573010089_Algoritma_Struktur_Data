...
//---Hagher-Order Function: memo wrapper universal ---
...
const fibMemo = memorize(function(n) {
    if (n<=1) return n;
...
const coinChangeMemo = memorize(function(jumlah, koin) {
...
const lcsMemo = memorize(function(s1, s2, i=s1.length-1, j=s2.length-1) {
    if (i<0 || j<0) return 0;
