...
class HashMap {
    ...
    hash(key) { return this.get(key) !== undefined; }
...
['javascript','python','c++','rust','go','typescript'].forEach((lang, i) => map.set(lang, i+1)); 

console.log('=== HashMap Demo ===');
console.log('get(java)    :', map.get('java'));
console.log('get(kotlin)    :', map.get('kotlin'));
console.log('hash(python)  :', map.hash('python'));
map.delete('java');
console.log('Setelah hapus java:', map.hash('java'));
